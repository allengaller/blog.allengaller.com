...
# Read
- 翻译系列：, [程序员的思维修炼](), [The Productive Programmer 卓有成效的程序员](), [人人都有好工作:IT行业求职面试必读](), [番茄工作法图解:简单易行的时间管理方法]()  软件开发者路线图: 从学徒到高手
	- [一万小时天才理论]()
	- [少有人走的路:心智成熟的旅程]  
	- [编程人生:15位软件先驱访谈录]()  
	- [程序员的思维修炼:开发认知潜能的九堂课]()  
...
### Installation
# vim mongo_install.sh
apt-key adv --keyserver keyserver.ubuntu.com --recv 7F0CEB10
echo "deb http://downloads-distro.mongodb.org/repo/ubuntu-upstart dist 10gen" | tee -a /etc/apt/sources.list.d/10gen.list
apt-get -y update
apt-get -y install mongodb-10gen
# chmod 777 mongo_install.sh
...
## 微信公众平台方案
WeiPHP: [http://wuma.apps4coder.com](http://wuma.apps4coder.com) (a4c-wuma-sns)

## 支付宝服务窗方案

## 商城方案
http://magento.com/ (http://www.360magento.net/)
http://www.prestashop.com/

http://sylius.org/get-started
http://www.oscommerce.com/

http://www.shopex.cn/

## CRM方案
悟空CRM: http://www.5kcrm.com/

## CMS方案
- Wordpress
- Drupal: [https://www.drupal.org](https://www.drupal.org)
- Joomla: [http://www.joomla.org](http://www.joomla.org)
- Typo3: [http://typo3.org](http://typo3.org/)
- [momocms](http://momocms.youyax.com/)

## 社区方案
- http://www.thinksaas.cn/
- [StartBBS](http://www.startbbs.com/)
- http://www.oschina.net/p/widyphp

## 企业IM方案
[entboost](http://www.entboost.com)
